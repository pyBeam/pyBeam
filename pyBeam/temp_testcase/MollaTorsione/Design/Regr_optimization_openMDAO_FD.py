...
class Weight(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.declare_partials(of='Obj_f', wrt='C_wb', method='fd',form='central',step=1e-6)
        self.declare_partials(of='Obj_f', wrt='h', method='fd',form='central',step=1e-6)
        self.declare_partials(of='Obj_f', wrt='t_sk', method='fd',form='central',step=1e-6)
        self.declare_partials(of='Obj_f', wrt='t_sp', method='fd',form='central',step=1e-6)
        self.declare_partials(of='Obj_f', wrt='A_fl', method='fd',form='central',step=1e-6)
        #self.declare_partials(of='Obj_f', wrt='A_stiff', method='fd',form='central',step=1e-6)
...
class KS_constraint(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        # Finite difference all partials.
        self.declare_partials(of='Const_KS', wrt='C_wb', method='fd',form='central',step=1e-6)
        self.declare_partials(of='Const_KS', wrt='h', method='fd',form='central',step=1e-6)
        self.declare_partials(of='Const_KS', wrt='t_sk', method='fd',form='central',step=1e-6)
        self.declare_partials(of='Const_KS', wrt='t_sp', method='fd',form='central',step=1e-6)
        self.declare_partials(of='Const_KS', wrt='A_fl', method='fd',form='central',step=1e-6)
        #self.declare_partials(of='Const_KS', wrt='A_stiff', method='fd',form='central',step=1e-6)
...
if __name__ == "__main__":
   ...
   # prob.model.add_constraint('g2', equals=0)
    ...
    plt.savefig('../Optimization/Figures/Weight_' + str(n_stiff) + '_stiff_FD_nonlin.pdf')  # save the figure to file
    plt.close(fig1)
    ...
    plt.savefig('../Optimization/Figures/KSconstraint_' + str(n_stiff) + '_stiff_FD_nonlin.pdf')  # save the figure to file
    plt.close(fig2)
    ...
    plt.legend(['C_wb', 'h', 't_sk', 't_sp'], bbox_to_anchor=(1.05, 1), loc='upper left')
    plt.xlabel('Driver Iterations', fontsize=18)
    plt.ylabel('Design Variables', fontsize=16)

    plt.show()
    plt.savefig('../Optimization/Figures/DesignVAriables_' + str(n_stiff) + '_stiff_FD_nonlin.pdf')  # save the figure to file
    plt.close(fig3)
