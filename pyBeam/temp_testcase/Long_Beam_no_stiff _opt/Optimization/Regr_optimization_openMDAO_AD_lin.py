...
if __name__ == "__main__":
    ...
    prob.model.add_subsystem('Cwb_h_comp', om.ExecComp('g1 = h-0.1*C_wb'),
                             promotes=['*'])
   ...
   # prob.driver = om.ScipyOptimizeDriver()
    ...
    prob.model.add_design_var('A_fl',upper = 2000 )
    ...
    plt.savefig('../Optimization/Figures/Weight_' + str(n_stiff) + '_stiff_AD_nonlin.pdf')  # save the figure to file
    plt.close(fig1)
    ...
    plt.savefig('../Optimization/Figures/KSconstraint_' + str(n_stiff) + '_stiff_AD_nonlin.pdf')  # save the figure to file
    plt.close(fig2)
    ...
    plt.show()
    plt.savefig('../Optimization/Figures/DesignVAriables_' + str(n_stiff) + '_stiff_AD_nonlin.pdf')  # save the figure to file
    plt.close(fig3)
